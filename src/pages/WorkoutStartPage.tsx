import { IonButtons, IonButton, IonContent, IonHeader, IonIcon, IonImg, IonItem, IonList, IonBackButton, IonPage, IonTitle, IonToolbar, IonGrid, IonRow, IonCol } from '@ionic/react';
...
const WorkoutStartPage: React.FC = () => {
  ...
  useEffect(() => {    
    const ex = workoutItems.find(item => item.id.toString() === id);  
    setWorkout(ex);
  }, []);
        ...
        <IonGrid>
          ...
          <IonRow>
            <IonCol size="8" offset="2">
             <IonButton style={{ textTransform: 'uppercase' }} expand="full" fill="solid">Begin Workout</IonButton>
            </IonCol>
          </IonRow>
        </IonGrid>
